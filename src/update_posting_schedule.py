"""Apply AI-selected UTC posting windows to the THINK FAST DAILY workflow."""
import json
import re
...
WORKFLOW = ROOT / ".github" / "workflows" / "think-fast-daily.yml"
...
def main():
    ...
    # Need two distinct windows; otherwise keep the existing schedule.
